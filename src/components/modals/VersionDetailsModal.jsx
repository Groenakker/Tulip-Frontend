...
import { FaSave, FaTrash, FaPlus, FaTimes, FaEnvelope, FaCopy, FaExternalLinkAlt, FaComment } from "react-icons/fa";
...
const VersionDetailsModal = ({ version, onClose, onUpdate, onDelete }) => {
  ...
  const handleSendApprovalEmail = async (stakeholder) => {
    ...
    try {
      ...
      console.log("Sending approval email to:", stakeholder.email, "Link:", link);
